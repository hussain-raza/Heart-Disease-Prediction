...
st.title("10 YEAR HEART DISEASE PREDICTION")

st.write("By- HUSSAIN MOHD RAZA")
...
# Feature Engineering
# Transforming Input data of Yes/no from User in numbers(0 and 1)
...
# Function to transform education in numbers
def transform(data):
    result = 3
...
model = joblib.load('Heart-Disease-Pred-Model.pkl')
...
if st.button('Predict'):
    ...
    if(prediction[0]==0):
        ...
        st.error("You are likely to develop heart disease in 10 years.")
        st.image("F.jpg")
